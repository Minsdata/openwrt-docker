...
sed -i "3i uci set network.lan.ipaddr='172.17.1.1'"  ./lede/package/lean/default-settings/files/zzz-default-settings # Default IP address
...
sed -i "8i uci set network.lan.gateway='172.17.0.1'"  ./lede/package/lean/default-settings/files/zzz-default-settings  # Default gateway address (main route IP)
sed -i "9i uci set network.lan.dns='1.1.1.1'"  ./lede/package/lean/default-settings/files/zzz-default-settings  # Default upstream DNS address
